...
class SwinTransformer_Unrolled(nn.Module):
    ...
    def __init__(self, img_size=256, patch_size=4, in_chans=2, num_classes=2,
        ...
        for i_layer in range(self.num_layers):
            ...
            self.layers.append(DataConsistency(embed_dim, patchify=True, patch_size=patch_size))

        
        self.last_dc = DataConsistency(embed_dim, patchify=False, patch_size=patch_size)
